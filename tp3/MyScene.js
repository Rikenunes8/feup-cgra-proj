...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(183.0/256.0, 111.0/256.0, 32.0/256.0, 1.0);
        this.material4.setDiffuse(86.0/256.0, 52.0/256.0, 42.0/256.0, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(0.1*this.ambientLight, 0.1*this.ambientLight, 0.1*this.ambientLight, 1.0);
